...
class SystemManualControllerTest extends TestCase
{
    ...
    public function test_un_administrador_normal_no_puede_ver_el_manual(): void
    {
        $admin = User::factory()->create(['role' => 'admin']);

        $this->actingAs($admin)->get('/admin/system-manual')->assertForbidden();
        $this->actingAs($admin)->get('/admin/system-manual/download')->assertForbidden();
    }
    ...
    public function test_super_admin_puede_descargar_el_pdf(): void
    {
        ...
        $response = $this->actingAs($superAdmin)->get('/admin/system-manual/download');
