<x-admin-layout title="Panel">
    ...
    <div class="mt-8 grid gap-4 sm:grid-cols-3">
        <a href="{{ route('admin.messages.index') }}" class="rounded-2xl border border-paper-200 bg-paper-alt p-5 transition-colors hover:border-sky-300">
    ...
    <div class="mt-10 grid gap-4 sm:grid-cols-2">
        <a href="{{ route('admin.theme.edit') }}" class="rounded-2xl border border-paper-200 bg-paper-alt p-5 hover:border-sky-300">
        ...
        <a href="{{ route('admin.logo.edit') }}" class="rounded-2xl border border-paper-200 bg-paper-alt p-5 hover:border-sky-300">
        ...
        <a href="{{ route('admin.contact.edit') }}" class="rounded-2xl border border-paper-200 bg-paper-alt p-5 hover:border-sky-300">
        ...
        <a href="{{ route('admin.content.edit', 'hero') }}" class="rounded-2xl border border-paper-200 bg-paper-alt p-5 hover:border-sky-300">
    ...
    @if ($recentCheckups->isNotEmpty())
        <div class="mt-10">
            ...
            <div class="mt-3 overflow-x-auto rounded-2xl border border-paper-200 bg-paper-alt">
